...
- (NSString *)findSymbolAtRVA:(NSUInteger)rva {
    ...
    return (symbolName != nil ? symbolName
                              : [NSString stringWithFormat:@"0x%lX", (unsigned long)rva]);
}
...
- (uint32_t)fileOffsetToRVA:(NSUInteger)offset {
    ...
    SegmentInfoMap::const_iterator segIter = segmentInfo.upper_bound((uint32_t)offset);
    if (segIter == segmentInfo.begin()) {
        [NSException raise:@"fileOffsetToRVA"
                    format:@"no segment found at offset 0x%lX", (unsigned long)offset];
    }
    --segIter;
...
- (uint64_t)fileOffsetToRVA64:(uint64_t)offset {
    ...
    SegmentInfoMap::const_iterator segIter =
        segmentInfo.upper_bound((uint32_t)offset);
...
- (uint32_t)RVAToFileOffset:(NSUInteger)rva {
    ...
    if (sectIter == sectionInfo.begin()) {
        [NSException raise:@"RVAToFileOffset"
                    format:@"no section found at address 0x%lX", rva];
    }
    --sectIter;
    ...
    NSAssert1(fileOffset < [dataController.fileData length],
              @"rva is out of range (0x%lX)", (unsigned long)rva);
...
- (uint32_t)RVA64ToFileOffset:(uint64_t)rva64 {
    ...
    if (sectIter == sectionInfo.begin()) {
        [NSException raise:@"RVA64ToFileOffset"
                    format:@"no section found at address 0x%lX", (unsigned long)rva64];
    }
    --sectIter;
    uint32_t sectOffset = sectIter->second.first;
    uint32_t fileOffset =
        sectOffset + (uint32_t)(rva64 - [self fileOffsetToRVA64:sectOffset]);

    NSAssert1(fileOffset < [dataController.fileData length],
              @"rva is out of range (0x%lX)", (unsigned long)rva64);
...
//-----------------------------------------------------------------------------
- (NSDictionary *)sectionInfoForRVA:(NSUInteger)rva {
    NSParameterAssert([self is64bit] == NO);
    SectionInfoMap::iterator iter = sectionInfo.upper_bound(rva);
    if (iter == sectionInfo.begin()) {
        NSLog(@"warning: no section info found for address 0x%.8lX", (unsigned long)rva);
        return nil;
    }
...
//-----------------------------------------------------------------------------
- (NSDictionary *)sectionInfoForRVA64:(NSUInteger)rva64 {
    NSParameterAssert([self is64bit] == YES);
    SectionInfoMap::iterator iter = sectionInfo.upper_bound(rva64);
    if (iter == sectionInfo.begin()) {
        NSLog(@"warning: no section info found for address 0x%.16lX", (unsigned long)rva64);
        return nil;
    }
    return (--iter)->second.second;
}
...
//------------------------------------------------------------------------------
- (MVNode *)sectionNodeContainsRVA64:(NSUInteger)rva64 {
    NSDictionary *userInfo = [self sectionInfoForRVA64:rva64];
    return (userInfo ? [self findNodeByUserInfo:userInfo] : nil);
}
    ...
    for (Section64Vector::iterator sectIter =
        ...
        @try {
            ...
            do {
                ...
                location += length + /*length itself */ sizeof(uint32_t);
            } while ((uint64_t)(location - section_64->offset - imageOffset) <
                     section_64->size);
        } @catch (NSException *exception) {
            [self printException:exception caption:lastNodeCaption];
        }
    ...
    @try {
        ...
        if (hasObjCModules == false) {
            section = [self findSectionByName:"__category_list"
                                   andSegment:"__OBJC2"];
            if (section == NULL) section = [self findSectionByName:"__objc_catlist"
                                                        andSegment:"__DATA"];
            if ((sectionNode = [self
            ...
            section = [self findSectionByName:"__class_list"
                                   andSegment:"__OBJC2"];
            if (section == NULL) section = [self findSectionByName:"__objc_classlist"
                                                        andSegment:"__DATA"];
            if ((sectionNode = [self
                                findNodeByUserInfo:[self userInfoForSection:section]])) {
                [self createObjC2PointerListNode:sectionNode
            ...
            section = [self findSectionByName:"__class_refs"
                                   andSegment:"__OBJC2"];
            if (section == NULL) section = [self findSectionByName:"__objc_classrefs"
                                                        andSegment:"__DATA"];
            if ((sectionNode = [self
                                findNodeByUserInfo:[self userInfoForSection:section]])) {
                [self createObjC2PointerListNode:sectionNode
            ...
            section = [self findSectionByName:"__super_refs"
                                   andSegment:"__OBJC2"];
            if (section == NULL) section = [self findSectionByName:"__objc_superrefs"
                                                        andSegment:"__DATA"];
            if ((sectionNode = [self
                                findNodeByUserInfo:[self userInfoForSection:section]])) {
                [self createObjC2PointerListNode:sectionNode
            ...
            section = [self findSectionByName:"__protocol_list"
                                   andSegment:"__OBJC2"];
            if (section == NULL) section = [self findSectionByName:"__objc_protolist"
                                                        andSegment:"__DATA"];
            if ((sectionNode = [self
                                findNodeByUserInfo:[self userInfoForSection:section]])) {
                [self createObjC2PointerListNode:sectionNode
            ...
            section = [self findSectionByName:"__message_refs"
                                   andSegment:"__OBJC2"];
            if (section == NULL) section = [self findSectionByName:"__objc_msgrefs"
                                                        andSegment:"__DATA"];
            if ((sectionNode = [self
                                findNodeByUserInfo:[self userInfoForSection:section]])) {
        ...
        if (section == NULL) section = [self findSectionByName:"__objc_imageinfo"
                                                    andSegment:"__DATA"];
        if ((sectionNode =
                 [self findNodeByUserInfo:[self userInfoForSection:section]])) {
            [self
...
- (void)processObjcSections64 {
    ...
    @try {
        section_64 = [self findSection64ByName:"__class_list"
                                    andSegment:"__OBJC2"];
        if (section_64 == NULL) section_64 = [self findSection64ByName:"__objc_classlist"
                                                            andSegment:"__DATA"];
        if ((sectionNode = [self
        ...
        section_64 = [self findSection64ByName:"__class_refs"
                                    andSegment:"__OBJC2"];
        if (section_64 == NULL) section_64 = [self findSection64ByName:"__objc_classrefs"
                                                            andSegment:"__DATA"];
        if ((sectionNode = [self
                            findNodeByUserInfo:[self userInfoForSection64:section_64]])) {
            [self createObjC2Pointer64ListNode:sectionNode
        ...
        section_64 = [self findSection64ByName:"__super_refs"
                                    andSegment:"__OBJC2"];
        if (section_64 == NULL) section_64 = [self findSection64ByName:"__objc_superrefs"
                                                            andSegment:"__DATA"];
        if ((sectionNode = [self
                            findNodeByUserInfo:[self userInfoForSection64:section_64]])) {
            [self createObjC2Pointer64ListNode:sectionNode
        ...
        section_64 = [self findSection64ByName:"__category_list"
                                    andSegment:"__OBJC2"];
        if (section_64 == NULL) section_64 = [self findSection64ByName:"__objc_catlist"
                                                            andSegment:"__DATA"];
        if ((sectionNode = [self
                            findNodeByUserInfo:[self userInfoForSection64:section_64]])) {
            [self createObjC2Pointer64ListNode:sectionNode
        ...
        section_64 = [self findSection64ByName:"__protocol_list"
                                    andSegment:"__OBJC2"];
        if (section_64 == NULL) section_64 = [self findSection64ByName:"__objc_protolist"
                                                            andSegment:"__DATA"];
        if ((sectionNode = [self
                            findNodeByUserInfo:[self userInfoForSection64:section_64]])) {
            [self createObjC2Pointer64ListNode:sectionNode
        ...
        section_64 = [self findSection64ByName:"__message_refs"
                                    andSegment:"__OBJC2"];
        if (section_64 == NULL) section_64 = [self findSection64ByName:"__objc_msgrefs"
                                                            andSegment:"__DATA"];
        if ((sectionNode = [self
                            findNodeByUserInfo:[self userInfoForSection64:section_64]])) {
        ...
        section_64 = [self findSection64ByName:"__image_info"
                                    andSegment:"__OBJC"];
        if (section_64 == NULL) section_64 = [self findSection64ByName:"__objc_imageinfo"
                                                            andSegment:"__DATA"];
        if ((sectionNode = [self
                            findNodeByUserInfo:[self userInfoForSection64:section_64]])) {
            [self
...
- (MVNode *)createMachONode:(MVNode *)parent
    ...
    if (mach_header->cputype == CPU_TYPE_ARM) {
        if ((mach_header->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_ARM_ALL) [node.details appendRow:@"":@"":@"00000000":@"CPU_SUBTYPE_ARM_ALL"];
        if ((mach_header->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_ARM_V4T) [node.details appendRow:@"":@"":@"00000005":@"CPU_SUBTYPE_ARM_V4T"];
        if ((mach_header->cpusubtype & ~CPU_SUBTYPE_MASK) == CPU_SUBTYPE_ARM_V6) [node.details appendRow:@"":@"":@"00000006":@"CPU_SUBTYPE_ARM_V6"];
        if ((mach_header->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_ARM_V5TEJ) [node.details appendRow:
                                    @""                   :@"":@"00000007":@"CPU_SUBTYPE_ARM_V5TEJ"];
        if ((mach_header->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_ARM_XSCALE) [node.details appendRow:
        ...
        if ((mach_header->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_ARM_V6M) [node.details appendRow:@"":@"":@"0000000E":@"CPU_SUBTYPE_ARM_V6M"];
        if ((mach_header->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_ARM_V7M) [node.details appendRow:@"":@"":@"0000000F":@"CPU_SUBTYPE_ARM_V7M"];
        if ((mach_header->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_ARM_V7EM) [node.details appendRow:
        ...
        if ((mach_header->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_I386_ALL) [node.details appendRow:
                                   @""                   :@"":@"00000003":@"CPU_SUBTYPE_I386_ALL"];
    } else if (mach_header->cputype == CPU_TYPE_ANY) {
        if ((mach_header->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_MULTIPLE) [node.details appendRow:
        ...
        if ((mach_header->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_BIG_ENDIAN) [node.details appendRow:
    ...
    if (mach_header->flags & MH_SUBSECTIONS_VIA_SYMBOLS) [node.details appendRow:
    ...
    if (mach_header->flags & MH_ALLOW_STACK_EXECUTION) [node.details appendRow:
    ...
    if (mach_header->flags & MH_DEAD_STRIPPABLE_DYLIB) [node.details appendRow:
...
- (MVNode *)createMachO64Node:(MVNode *)parent
    ...
    if (mach_header_64->cputype == CPU_TYPE_X86_64) {
        if ((mach_header_64->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_X86_64_ALL) [node.details appendRow:
                                     @""                   :@"":@"00000003":@"CPU_SUBTYPE_X86_64_ALL"];
    } else if (mach_header_64->cputype == CPU_TYPE_ARM64) {
        if ((mach_header_64->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_ARM64_ALL) [node.details appendRow:
                                    @""                   :@"":@"00000000":@"CPU_SUBTYPE_ARM64_ALL"];
        if ((mach_header_64->cpusubtype & ~CPU_SUBTYPE_MASK) ==
            CPU_SUBTYPE_ARM64_V8) [node.details appendRow:
    ...
    if (mach_header_64->flags & MH_SUBSECTIONS_VIA_SYMBOLS) [node.details appendRow:
                                                             @""                   :@"":@"00002000":@"MH_SUBSECTIONS_VIA_SYMBOLS"];
    ...
    if (mach_header_64->flags & MH_ALLOW_STACK_EXECUTION) [node.details appendRow:
                                                           @""                   :@"":@"00020000":@"MH_ALLOW_STACK_EXECUTION"];
    ...
    if (mach_header_64->flags & MH_DEAD_STRIPPABLE_DYLIB) [node.details appendRow:
                                                           @""                   :@"":@"00400000":@"MH_DEAD_STRIPPABLE_DYLIB"];
...
- (void)doBackgroundTasks {
    NSBlockOperation *linkEditOperation =
        [NSBlockOperation blockOperationWithBlock:^{
            ...
            @autoreleasepool {
                if ([self is64bit] == NO) [self processLinkEdit];
                else [self processLinkEdit64];
            }
            NSLog(@"%@: LinkEdit finished parsing. (%lu symbols found)", self,
                  [self is64bit] == NO ?
                  self->symbols.size() :
                  self->symbols_64.size());
        }];
    ...
    NSBlockOperation *sectionRelocsOperation =
        [NSBlockOperation blockOperationWithBlock:^{
            if ([self->backgroundThread isCancelled]) return;
            @autoreleasepool {
                if ([self is64bit] == NO) [self processSectionRelocs];
                else [self processSectionRelocs64];
            }
    ...
    NSBlockOperation *sectionOperation =
        [NSBlockOperation blockOperationWithBlock:^{
            if ([self->backgroundThread isCancelled]) return;
            @autoreleasepool {
                if ([self is64bit] == NO) [self processSections];
                else [self processSections64];
            }
    ...
    NSBlockOperation *EHFramesOperation =
        [NSBlockOperation blockOperationWithBlock:^{
            if ([self->backgroundThread isCancelled]) return;
            @autoreleasepool {
                if ([self is64bit] == NO) [self processEHFrames];
                else [self processEHFrames64];
            }
    ...
    NSBlockOperation *LSDAsOperation =
        [NSBlockOperation blockOperationWithBlock:^{
            if ([self->backgroundThread isCancelled]) return;
            @autoreleasepool {
                if ([self is64bit] == NO) [self processLSDA];
                else [self processLSDA64];
            }
            NSLog(@"%@: Lang Spec Data Areas finished parsing. (%lu LSDAs found)",
                  self, self->lsdaInfo.size());
        }];
    ...
    NSBlockOperation *objcSectionOperation =
        [NSBlockOperation blockOperationWithBlock:^{
            if ([self->backgroundThread isCancelled]) return;
            @autoreleasepool {
                if ([self is64bit] == NO) [self processObjcSections];
                else [self processObjcSections64];
            }
    ...
    NSBlockOperation *codeSectionsOperation =
        [NSBlockOperation blockOperationWithBlock:^{
            if ([self->backgroundThread isCancelled]) return;
            @autoreleasepool {
                if ([self is64bit] == NO) [self processCodeSections];
                else [self processCodeSections64];
            }
